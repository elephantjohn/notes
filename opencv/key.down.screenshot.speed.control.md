...
project( keydownScreenshotSpeedControl )

# opencv 库
find_package( OpenCV REQUIRED )
include_directories( ${OpenCV_INCLUDE_DIRS} )
	
add_executable(keydownScreenshotSpeedControl  keydownScreenshotSpeedControl.cpp )
target_link_libraries( keydownScreenshotSpeedControl ${OpenCV_LIBS} pthread dl )
```

# brief

take screenshot by keydown 's' of 'S' ,you can control the video speed by some keys
...
cmake .
make
./keydownScreenshotSpeedControl xxx.mp4
```